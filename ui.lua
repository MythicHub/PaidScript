if game:GetService("CoreGui"):FindFirstChild("MYTHICLIB") then
    game:GetService("CoreGui"):FindFirstChild("MYTHICLIB"):Destroy()
end
local Flux = {RainbowColorValue = 0, HueSelectionPosition = 0}
local PresetColor = Color3.fromRGB(235, 64, 52)
...
local MYTHICLIB = Instance.new("ScreenGui")
MYTHICLIB.Name = "MYTHICLIB"
MYTHICLIB.Parent = game.CoreGui
MYTHICLIB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
		...
		function(io, p)
			if io.KeyCode == CloseBind then
				if uitoggled == false then
					...
					uitoggled = true
					wait(.5)
					MYTHICLIB.Enabled = false
				else
					MainFrame:TweenSize(UDim2.new(0, 706, 0, 484), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					MYTHICLIB.Enabled = true
					uitoggled = false
				end
			end
		end
